...
def main():
    p=argparse.ArgumentParser(); p.add_argument("scenario",type=Path); p.add_argument("--output",type=Path,default=Path("artifacts/course-evidence.json")); p.add_argument("--apply",action="store_true")
